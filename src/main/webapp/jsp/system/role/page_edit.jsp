    ...
    <c:choose>
        <c:when test="${page.name=='组'}">
            ...
            <div id="zhongxin">
                <table>
                    <tr>
                        <td><input type="text" name="Name" id="groupName" value="${group.groupName}"
                                   placeholder="这里输入${page.name}名称"
                                   title="${page.name}名称"/></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="Description" id="groupDescription" value="${group.description}"
                                   placeholder="这里输入${page.name}描述"
        ...
        <c:otherwise>
            ...
            <div id="zhongxin">
                <table>
                    <tr>
                        <td><input type="text" name="Name" id="roleName" value="${role.roleName}"
                                   placeholder="这里输入${page.name}名称"
                                   title="${page.name}名称"/></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="Description" id="roleDescription" value="${role.description}"
                                   placeholder="这里输入${page.name}描述"
                                   title="${page.name}描述"/></td>
                    </tr>
                    <tr>
